...
<form name="forms.oggettiEditForm" novalidate>
	<div class="box box-framework">
		...
		<div class="box-body">
			...
			<div class="qrow">
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
					ng-class="{'qhas-error': forms.oggettiEditForm.descrizione.$invalid}">
					<label for="descrizione"><s:text
							name="oggetti.edit.descrizione" /></label> <input type="text"
						ng-model="scopeController.selectedRow.descrizione"
						id="descrizione" name="descrizione" class="qform-control" />
					<div ng-messages="forms.oggettiEditForm.descrizione.$error"
						role="alert">
						<div ng-message="notNull">
							<s:text name="error.notNull" />
						</div>
			...
			<div class="qrow">
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
					ng-class="{'qhas-error': forms.oggettiEditForm.categoria.$invalid}">
					<label for="categoria"><s:text
							name="oggetti.edit.categoria" /></label>
					...
					<div ng-messages="forms.oggettiEditForm.categoria.$error"
						role="alert">
						<div ng-message="notNull">
							<s:text name="error.notNull" />
						</div>
				...
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
					ng-class="{'qhas-error': forms.oggettiEditForm.immagine.$invalid}">
					...
					<div ng-messages="forms.oggettiEditForm.immagine.$error"
						role="alert">
						<div ng-message="notNull">
							<s:text name="error.notNull" />
						</div>
				...
				<div class="qrow">
					<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
						ng-class="{'qhas-error': forms.oggettiEditForm.soggetti.$invalid}">
						<label for="in_prestito_a"><s:text
								name="oggetti.edit.in_prestito_a" /></label> <input type="text"
							ng-model="scopeController.selectedRow.in_prestito_a"
							id="in_prestito_a" name="in_prestito_a" class="qform-control" />
						<div ng-messages="forms.oggettiEditForm.soggetti.$error"
							role="alert">
							<div ng-message="notNull">
								<s:text name="error.notNull" />
							</div>
				...
				<div class="qrow">
					<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
						ng-class="{'qhas-error': forms.oggettiEditForm.data_ultima_modifica.$invalid}">
						<label for="data_prestito"><s:text
								name="oggetti.edit.data_prestito" /></label>
						<div class="qdropdown">
							<a class="qdropdown-toggle" id="dropdown2" role="qbutton"
								data-toggle="qdropdown" data-target="#" href="#">
								<div class="qinput-group">
									<input type="text" name="data_prestito" id="data_prestito"
										class="qform-control box-input-calendar"
										data-ng-model="scopeController.selectedRow.data_prestito"
						...
						<div ng-messages="forms.oggettiEditForm.data_prestito.$error"
							role="alert">
							<div ng-message="notNull">
								<s:text name="error.notNull" />
							</div>
				...
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
					ng-class="{'qhas-error': forms.oggettiEditForm.data_ultima_modifica.$invalid}">
					<label for="data_scadenza"><s:text
							name="oggetti.edit.data_scadenza" /></label>
					<div class="qdropdown">
						<a class="qdropdown-toggle" id="dropdown2" role="qbutton"
							data-toggle="qdropdown" data-target="#" href="#">
							<div class="qinput-group">
								<input type="text" name="data_scadenza" id="data_scadenza"
									class="qform-control box-input-calendar"
									data-ng-model="scopeController.selectedRow.data_scadenza"
									presetDate="true" dateformat="DD/MM/YYYY"> <span
									class="qinput-group-addon"><i class="fa fa-calendar"></i></span>
							</div>
						</a>
					...
					<div ng-messages="forms.oggettiEditForm.data_scadenza.$error"
						role="alert">
						<div ng-message="notNull">
							<s:text name="error.notNull" />
						</div>
	...
	<div class="box-footer qtext-center">
		<button ng-click="saveOggettiPrestiti()" class="qbtn btn-framework-color">
