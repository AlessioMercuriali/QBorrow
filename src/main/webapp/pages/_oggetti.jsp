	...
	<div class="box box-framework">
		...
		<div class="box-body" ng-show="!filtriEspansi" ng-cloak>
			...
			<span class="filterDiv" ng-if="scopeController.search.immagine != null && scopeController.search.immagine != ''">
				<s:text name="soggetti.search.ragione_sociale"/>: 
				<b>
					{{scopeController.search.immagine}}
				</b>
				&nbsp;&nbsp;<i class="fa fa-times-circle" style="cursor: pointer;" ng-click="removeFilter('ragione_sociale')"></i>
			</span>
			...
			<span class="filterDiv" ng-if="scopeController.search.data_ultima_modifica != null && scopeController.search.data_ultima_modifica != ''">
				<s:text name="soggetti.search.cognome"/>: 
				<b>
					{{scopeController.search.data_ultima_modifica}}
				</b>
		...
		<div class="box-body qfade " ng-show="filtriEspansi" ng-cloak>
			<div class="qrow">
				<div class="qcol-xs-12 qcol-sm-12 qcol-md-6" ng-class="{'qhas-error': forms.oggettiListForm.titolo.$invalid}">
					...
					<div>
						...
						<div ng-messages="forms.oggettiListForm.username.$error" role="alert">
			...
			<div class="qrow">
				<div class="qcol-xs-12 qcol-sm-12 qcol-md-6" ng-class="{'qhas-error': forms.oggettiListForm.immagine.$invalid}">
					<label for="immagine"><s:text name="oggetti.search.immagine"/>:</label>
					<div>
						<input type="text" ng-model="scopeController.search.immagine" id="immagine" class="qform-control" />
						<div ng-messages="forms.oggettiListForm.immagine.$error" role="alert">
						  	<div ng-message="notNull"><s:text name="error.notNull"/></div>
						  	<div ng-message="invalidAK"><s:text name="error.invalidAK"/></div>
						  	<div ng-message="notValid"><s:text name="error.notValid"/></div>
						  	<div ng-message="lenght"><s:text name="error.lenght"/></div>
			...
			<div class="qrow">
				<div class="qcol-xs-12 qcol-sm-12 qcol-md-6" ng-class="{'qhas-error': forms.oggettiListForm.data_ultima_modifica.$invalid}">
					<label for="data_ultima_modifica"><s:text name="ooggetti.search.data_ultima_modifica"/>:</label>
					<div>
						<input type="text" ng-model="scopeController.search.data_ultima_modifica" id="cognome" class="qform-control" />
						<div ng-messages="forms.oggettiListForm.data_ultima_modifica.$error" role="alert">
						  	<div ng-message="notNull"><s:text name="error.notNull"/></div>
						  	<div ng-message="invalidAK"><s:text name="error.invalidAK"/></div>
						  	<div ng-message="notValid"><s:text name="error.notValid"/></div>
						  	<div ng-message="lenght"><s:text name="error.lenght"/></div>
    	...
    	<table class="qtable qtable-hover">
			<thead>
				<tr>
					...
					<th class="qtext-left"><s:text name="oggetti.list.data_ultima_modifica"/></th>
					<th>&nbsp;</th>
				</tr>
			</thead>
			<tbody>
